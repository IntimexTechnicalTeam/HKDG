namespace HKDG.BLL
{
    public class UpdateQtyWhenModifyCartService : AbstractCalculateQtyService
    {
        IServiceProvider _service;
        public UpdateQtyWhenModifyCartService(IServiceProvider services) : base(services)
        {
        ...
        public override async Task<SystemResult> CalcuteQty(Guid SkuId, int Qty, Guid MsgId)
        {
            ...
            var result = await base.SendCalculateQty(InvtActualQty, InvtHoldQty, SalesQty, InvtReservedQty, SkuId, MsgId, QtyType.WhenModifyCart);
            return result;
        }
    }
}
