...
namespace HKDG.BLL
{
    public class DeliveryBLL : BaseBLL, IDeliveryBLL
    {
        ...
        public KeyValue GetMerchantNameBySelect(Guid id)
        {
            ...
            list.Id = id.ToString();
            list.Text = HKDG.Resources.Value.Mall;
            if (MerchantName == "")
                list.Text = HKDG.Resources.Value.Mall;
            else
        ...
        public SystemResult SaveCountry(CountryDto model)
        {
            ...
            result.Succeeded = true;
            result.Message = HKDG.Resources.Message.UpdateSuccess;
        ...
        public SystemResult SaveExpressRulePrice(TransRulePrice obj)
        {
            ...
            {
                result.Message = HKDG.Resources.Message.AddZoneFirst;
            }
            return result;
        }
        /// <summary>
            ...
            else
            {
                ...
                if (tmpZone != null)
                {
                    ...
                    if (tmpPricelist.Count() > 0)
                    {
                        ...
                        result.Message = HKDG.Resources.Message.SaveSuccessButMod;
                    }
                    else
                    {
