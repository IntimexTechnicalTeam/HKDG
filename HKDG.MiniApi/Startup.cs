using HKDG.MiniApi.Filters;
using Microsoft.AspNetCore.Authorization;

namespace HKDG.MiniApi
{
    public static class Startup
    {
        ...
        public static void ConfigureServices(WebApplicationBuilder builder)
        {
            ...
            //追加API 参数描述
            SwaggerExtension.AddSwagger(builder.Services, "HKDG.MiniApixml", "HKDG.Domain.xml");
        ...
        static void AddControllers(IServiceCollection services)
        {
            services.AddControllers(options =>
            {
                ...
                //options.Filters.Add(typeof(UserAuthorizeAttribute));  //MiniApi好像并不支持Filter
