namespace HKDG.Admin.Controllers
{
    ...
    public class ProductController : BaseMvcController
    {
        ...
        //            line++;
        //        }
        //        string returnPath = PathUtil.GetSiteRoot() + "/ClientResources/" + HKDG.Runtime.Setting.AppId + "/temp";
        //        string path = PathUtil.GetTempFileDirectory(HKDG.Runtime.Setting.ClientId);
