    ...
    public  class Startup
    {
       ...
       {           
            builder.Services.AddRazorPages(options =>{
                //options.Conventions.AddPageRoute("/Home/Test", "");
            })
            .AddNewtonsoftJson(options =>
                ...
                //.AddRazorPagesOptions(op=>op.Conventions.al)
                //.AddRazorPagesOptions(op=>op.Conventions.AddPageRoute("/Home/Index","").)
       ...
       public static void ConfigurePipeLine(IApplicationBuilder app, WebApplicationBuilder builder)
        {
            ...
            //        pattern: "/{controller=Home}/{action=Index}/{id?}/{para2?}/{para3?}");  //让MVC Controller支持无参或一个参数以上
            //});
        }
